...
from cliniar.auth import get_viewer
from cliniar.cli_state import build_client, get_state
from cliniar.errors import NotFoundError, UsageError
from cliniar.filters import build_issue_filter
from cliniar.graphql import mutations, queries
from cliniar.models.issue import Issue
from cliniar.models.project import Project
from cliniar.models.team import Team
from cliniar.output import render
...
async def _resolve_project_id(client, value: str) -> str:
    ...
    raise NotFoundError(
        ...
        "Use `cliniar project list` to see available projects."
    )
...
async def _run_create(**kwargs) -> None:
    ...
    async with build_client(state) as client:
        ...
        if flat_labels:
            from cliniar.commands.label import resolve_label_ids
