...
from cliniar.config import redact_token
from cliniar.errors import (
    APIError,
    AuthError,
    NetworkError,
    RateLimitError,
...
logger = logging.getLogger("cliniar.client")
        ...
        *,
        ...
        self._http = httpx.AsyncClient(
            ...
            headers={
                ...
                "User-Agent": f"cliniar/{__version__} (+https://github.com/rinadelph/cliniar)",
            },
        )
